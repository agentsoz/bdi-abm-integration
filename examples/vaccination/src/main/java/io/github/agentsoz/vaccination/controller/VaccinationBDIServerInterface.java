...
public interface VaccinationBDIServerInterface extends BDIServerInterface {

	/**
	 * Create the agents specified by the agent IDs
	 * 
	 * @param agentIDs
	 */
	...
	/**
	 * Kill the agents from the system using the given agent IDs
	 * 
	 * @param agentIDs
	 */
