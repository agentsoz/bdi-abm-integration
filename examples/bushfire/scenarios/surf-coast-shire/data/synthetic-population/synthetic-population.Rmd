...
start_time=start_time+sample(c(-99:-40,0:59),length(start_time))
...
base_boundary<-5752511
top_boundary<-5764423
left_boundary<-770598
right_boundary<-788160
home[3]<-sample(base_boundary:top_boundary,1)
home[2]<-sample(left_boundary:right_boundary,1)
# if(home[3]<5729194){home[2]<-sample(left_boundary:752929,1)}
# else if(home[3]<5738141){home[2]<-sample(left_boundary:759270,1)}
# else if(home[3]<5742132){home[2]<-sample(left_boundary:771193,1)}
# else if(home[3]<5744745){home[2]<-sample(left_boundary:777230,1)}
# else if(home[3]<5745565){home[2]<-sample(left_boundary:779478,1)}
# else if(home[3]<5747801){home[2]<-sample(left_boundary:783727,1)}
# else if(home[3]<5750705){home[2]<-sample(left_boundary:785814,1)}
# else if(home[3]<5753911){home[2]<-sample(left_boundary:789393,1)}
# else if(home[3]<5756781){home[2]<-sample(left_boundary:793240,1)}
...
saveXML(doc,"plans_fuzz.xml")

suppressMessages(plans<-bind_rows(PLANS))
write.csv(plans,file="plans_fuzz.csv",row.names = F)
