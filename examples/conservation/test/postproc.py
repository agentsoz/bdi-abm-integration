...
filenames = ["auction_statistics_001.csv", "agents_ce_001.csv", "agents_pm_001.csv", "bids_001.csv", "config_parameters.csv", "number_of_bids_per_agent001.csv", "number_of_successful_bids_per_agent001.csv", "successful_bid_price_per_agent001.csv", "successful_opportunity_cost_per_agent001.csv", "total_bid_price_per_agent001.csv", "total_opportunity_cost_per_agent001.csv"]
