...
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=2 && VISIT_PERCENTAGE=70  && VISIT_PERCENTAGE_PER_AGENT=100 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t2p70p100
HI_CE_AGENTS_PERCENTAGE=75 && VISIT_TYPE=2 && VISIT_PERCENTAGE=70  && VISIT_PERCENTAGE_PER_AGENT=100 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice75.visit.t2p70p100
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=2 && VISIT_PERCENTAGE=30  && VISIT_PERCENTAGE_PER_AGENT=100 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t2p30p100
HI_CE_AGENTS_PERCENTAGE=75 && VISIT_TYPE=2 && VISIT_PERCENTAGE=30  && VISIT_PERCENTAGE_PER_AGENT=100 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice75.visit.t2p30p100
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=2 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=70  && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t2p100p70
HI_CE_AGENTS_PERCENTAGE=75 && VISIT_TYPE=2 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=70  && run $PBS_O_WORKDIR/`basename "$0"`.output.hice75.visit.t2p100p70
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=2 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=30  && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t2p100p30
HI_CE_AGENTS_PERCENTAGE=75 && VISIT_TYPE=2 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=30  && run $PBS_O_WORKDIR/`basename "$0"`.output.hice75.visit.t2p100p30
