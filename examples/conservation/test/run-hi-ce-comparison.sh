...
# HC25, Visit all successful + lowband unsuccessful (type 6)
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=6 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=25 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t6p100p25
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=6 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=50 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t6p100p50
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=6 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=75 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t6p100p75
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=6 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=100 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t6p100p100

# HC25, Visit all successful + midband unsuccessful (type 5)
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=5 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=25 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t5p100p25
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=5 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=50 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t5p100p50
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=5 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=75 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t5p100p75
HI_CE_AGENTS_PERCENTAGE=25 && VISIT_TYPE=5 && VISIT_PERCENTAGE=100 && VISIT_PERCENTAGE_PER_AGENT=100 && run $PBS_O_WORKDIR/`basename "$0"`.output.hice25.visit.t5p100p100
