...
cycles=args[2]
input_names = c('numAgents','highCEAgentsPercentage', 'targetPercentage', 'sigmoidMaxStepX', 'profitMotiveUpdateMultiplier', 'socialNormUpdateMultiplier', 'visitType', 'visitPercentage' )
