 ...
 */
public class DecideParticipationWhenHighCHighPPlan extends Plan {
	Landholder landholder;

	public DecideParticipationWhenHighCHighPPlan(Agent agent, Goal goal,
			String name) {
