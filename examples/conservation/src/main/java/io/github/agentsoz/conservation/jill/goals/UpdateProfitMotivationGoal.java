 ...
 */
@GoalInfo(hasPlans = { "io.github.agentsoz.conservation.jill.plans.HighP",
		"io.github.agentsoz.conservation.jill.plans.LowP" })
public class UpdateProfitMotivationGoal extends Goal {
	/**
	 * Results about current auction round
	 */
	private AuctionRound myResults;;

	public UpdateProfitMotivationGoal(String str) {
		super(str);
	}

	public UpdateProfitMotivationGoal(String str, AuctionRound results) {
		super(str);
